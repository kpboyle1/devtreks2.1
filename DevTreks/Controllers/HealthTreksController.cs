...
{
    /// <summary>
    ///Purpose:		Manages services and models for the healthtreks views
    ///Author:		www.devtreks.org
    ///Date:		2016, March
    ///References:	
    /// </summary>
    public class HealthTreksController : Controller, IDevTreksController1
    {
        public const string HEALTH_TREKS = "HealthTreks";
        ...
        private ILogger<HealthTreksController> _logger { get; set; }
        //2.0.0 changes
        public HealthTreksController(IOptions<DevTreks.Data.ContentURI> uri,
            ILogger<HealthTreksController> logger)
        {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            {
                ViewData["Title"] = AppHelper.GetResource("HEALTHTREKS_TITLE");
                return View();
            }
            else
            {
        ...
        public async Task<ActionResult> SearchAction(string contenturipattern)
        {
            ...
            ViewData["NetworkGroup"] = HEALTH_TREKS;
