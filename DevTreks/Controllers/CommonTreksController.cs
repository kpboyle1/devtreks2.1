...
{
    /// <summary>
    ///Purpose:		Manages services and models for the commontreks views
    ///Author:		www.devtreks.org
    ///Date:		2016, March
    ///References:	
    /// </summary>
    public class CommonTreksController : Controller, IDevTreksController1
    {
        public const string COMMON_TREKS = "CommonTreks";
        ...
        private ILogger<CommonTreksController> _logger { get; set; }
        //2.0.0 changes
        public CommonTreksController(IOptions<DevTreks.Data.ContentURI> uri,
            ILogger<CommonTreksController> logger)
        {
        ...
        public async Task<ActionResult> SearchAction(string contenturipattern)
        {
            ...
            ViewData["NetworkGroup"] = COMMON_TREKS;
