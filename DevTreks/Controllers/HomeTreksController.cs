...
{
    /// <summary>
    ///Purpose:		Manages services and models for the hometreks views
    ///Author:		www.devtreks.org
    ///Date:		2016, March
    ///References:	
    /// </summary>
    public class HomeTreksController : Controller, IDevTreksController1
    {
        public const string HOME_TREKS = "HomeTreks";
        ...
        public async Task<ActionResult> SearchAction(string contenturipattern)
        {
            ...
            ViewData["NetworkGroup"] = HOME_TREKS;
