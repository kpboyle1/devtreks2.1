...
{
    /// <summary>
    ///Purpose:		Manages services and models for the greentreks views
    ///Author:		www.devtreks.org
    ///Date:		2016, March
    ///References:	
    /// </summary>
    public class GreenTreksController : Controller, IDevTreksController1
    {
        public const string GREEN_TREKS = "GreenTreks";
        ...
        private ILogger<GreenTreksController> _logger { get; set; }
        //2.0.0 changes
        public GreenTreksController(IOptions<DevTreks.Data.ContentURI> uri,
            ILogger<GreenTreksController> logger)
        {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            {
                ViewData["Title"] = AppHelper.GetResource("GREENTREKS_TITLE");
                return View();
            }
            else
            {
        ...
        public async Task<ActionResult> SearchAction(string contenturipattern)
        {
            ...
            ViewData["NetworkGroup"] = GREEN_TREKS;
