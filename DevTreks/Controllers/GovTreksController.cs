...
{
    /// <summary>
    ///Purpose:		Manages services and models for the govtreks views
    ///Author:		www.devtreks.org
    ///Date:		2016, March
    ///References:	
    /// </summary>
    public class GovTreksController : Controller, IDevTreksController1
    {
        public const string GOV_TREKS = "GovTreks";
        ...
        private ILogger<GovTreksController> _logger { get; set; }
        //2.0.0 changes
        public GovTreksController(IOptions<DevTreks.Data.ContentURI> uri,
            ILogger<GovTreksController> logger)
        {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            {
                ViewData["Title"] = AppHelper.GetResource("GOVTREKS_TITLE");
                return View();
            }
            else
            {
        ...
        public async Task<ActionResult> SearchAction(string contenturipattern)
        {
            ...
            ViewData["NetworkGroup"] = GOV_TREKS;
