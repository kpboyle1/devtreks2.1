...
namespace DevTreks.Extensions
{
    ...
    ///NOTES        1. 
    /// </summary>
    public class OCSB1StockSubscriber : OperationComponentCalculatorAsync
    {
        //constructors
        public OCSB1StockSubscriber() { }
        //constructor sets class (base) properties
        public OCSB1StockSubscriber(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
