...
namespace DevTreks.Extensions
{
    ...
    ///NOTES        1. 
    /// </summary>
    public class OutcomeSB1StockSubscriber : OutcomeCalculatorAsync
    {
        //constructors
        public OutcomeSB1StockSubscriber() { }
        //constructor sets class (base) properties
        public OutcomeSB1StockSubscriber(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
