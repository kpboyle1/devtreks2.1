...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:template match="outputseries">
    ...
    <xsl:if test="(@SBCount >= 1)">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Amount Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Base Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Base Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Low Amount Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Low Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Low Base Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score Low Base Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score High Amount Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score High Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score High Base Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Score High Base Percent Change</strong></td>
			  <td>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
