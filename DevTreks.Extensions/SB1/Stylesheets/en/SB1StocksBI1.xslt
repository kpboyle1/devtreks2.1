...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Resource Stock Operating or Capital Budget Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic resource stock stock statistics for DevTreks capital budgets
	...
	<xsl:template match="linkedview">
      ...
      <div id="divsteptwo">
        ...
        <xsl:value-of select="DisplayDevPacks:WriteStandardCalculatorParams2($searchurl, $viewEditType,
          @WhatIfTagName, '')"/>
        <!--No RelatedCalculatorType because relys on relatedcalcstype set in linkedview xml-->
        <xsl:if test="(@AnalyzerType != 'sbtotal1')">
      ...
      <div id="divsteplast">
        ...
        <div data-role="collapsible"  data-theme="b" data-content-theme="d">
          ...
          <li><strong>Step 1. Stocks to Analyze:</strong> Choose up to 10 resource stock properties to analyze.</li>
			  </ul>
			  </div>
        <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			  <h4>Step 2</h4>
