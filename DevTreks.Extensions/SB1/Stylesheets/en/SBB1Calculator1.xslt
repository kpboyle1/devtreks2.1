	...
	<xsl:template match="linkedview">
     ...
     <h4 class="ui-bar-b"><strong>Stock Indicators</strong></h4>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
        ...
        <li><strong>Step 2. Confidence Interval:</strong> Level of confidence interal to use when reporting all Score and Indicator high and low amounts. Should be an integer such as 95, 90, or 40.  </li>
