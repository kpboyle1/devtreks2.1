 ...
 <xsl:template match="root/linkedview">
    ...
    <div data-role="collapsible" data-collapsed="false" data-theme="b" data-content-theme="a" >
      ...
      <xsl:if test="(@SB1Name1 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 1 Name: </strong><xsl:value-of select="@SB1Name1"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult1" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name2 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 2 Name: </strong><xsl:value-of select="@SB1Name2"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult2" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name3 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 3 Name: </strong><xsl:value-of select="@SB1Name3"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult3" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name4 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 4 Name: </strong><xsl:value-of select="@SB1Name4"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult4" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name5 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 5 Name: </strong><xsl:value-of select="@SB1Name5"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult5" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name6 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 6 Name: </strong><xsl:value-of select="@SB1Name6"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult6" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name7 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 7 Name: </strong><xsl:value-of select="@SB1Name7"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult7" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name8 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 8 Name: </strong><xsl:value-of select="@SB1Name8"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult8" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name9 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 9 Name: </strong><xsl:value-of select="@SB1Name9"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult9" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name10 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 10 Name: </strong><xsl:value-of select="@SB1Name10"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult10" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name11 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 11 Name: </strong><xsl:value-of select="@SB1Name11"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult11" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name12 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 12 Name: </strong><xsl:value-of select="@SB1Name12"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult12" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name13 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 13 Name: </strong><xsl:value-of select="@SB1Name13"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult13" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name14 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 14 Name: </strong><xsl:value-of select="@SB1Name14"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult14" />
	      </div>
      </xsl:if>
      <xsl:if test="(@SB1Name15 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 15 Name: </strong><xsl:value-of select="@SB1Name15"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@SB1MathResult15" />
	      </div>
      </xsl:if>
      ...
      <xsl:if test="(@TSB1Name1 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 1 Name: </strong><xsl:value-of select="@TSB1Name1"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult1" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name2 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 2 Name: </strong><xsl:value-of select="@TSB1Name2"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult2" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name3 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 3 Name: </strong><xsl:value-of select="@TSB1Name3"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult3" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name4 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 4 Name: </strong><xsl:value-of select="@TSB1Name4"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult4" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name5 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 5 Name: </strong><xsl:value-of select="@TSB1Name5"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult5" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name6 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 6 Name: </strong><xsl:value-of select="@TSB1Name6"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult6" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name7 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 7 Name: </strong><xsl:value-of select="@TSB1Name7"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult7" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name8 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 8 Name: </strong><xsl:value-of select="@TSB1Name8"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult8" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name9 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 9 Name: </strong><xsl:value-of select="@TSB1Name9"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult9" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name10 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 10 Name: </strong><xsl:value-of select="@TSB1Name10"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult10" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name11 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 11 Name: </strong><xsl:value-of select="@TSB1Name11"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult11" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name12 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 12 Name: </strong><xsl:value-of select="@TSB1Name12"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult12" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name13 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 13 Name: </strong><xsl:value-of select="@TSB1Name13"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult13" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name14 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 14 Name: </strong><xsl:value-of select="@TSB1Name14"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult14" />
	      </div>
      </xsl:if>
      <xsl:if test="(@TSB1Name15 != '')">
        <div class="ui-grid-a">
          <div class="ui-block-a">
            <strong>Indic 15 Name: </strong><xsl:value-of select="@TSB1Name15"/>
          </div>
          <div class="ui-block-b">
        ...
        <div>
			    Math Result: <xsl:value-of select="@TSB1MathResult15" />
	      </div>
      </xsl:if>
    </div>
    </xsl:if>
