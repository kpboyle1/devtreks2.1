...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:template match="inputseries">
    ...
    <xsl:if test="(@SB1Name1 != '')">
		  <tr>
        <td colspan="2">
          <strong><xsl:value-of select="@SB1Name1" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name2 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name2" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name3 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name3" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name4 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name4" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name5 != '')">
		 <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name5" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name6 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name6" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name7 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name7" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name8 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name8" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name9 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name9" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name10 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name10" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name11 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name11" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name12 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name12" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name13 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name13" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name14 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name14" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@SB1Name15 != '')">
		  <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@SB1Name15" /></strong> 
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name1 != '')">
      <tr>
        <td colspan="2">
					   <strong><xsl:value-of select="@TSB1Name1" /></strong> (<xsl:value-of select="@TSB1N1" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name2 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name2" /></strong>  (<xsl:value-of select="@TSB1N2" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name3 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name3" /></strong>  (<xsl:value-of select="@TSB1N3" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name4 != '')">
      <tr>
        <td colspan="2">
					 <strong><xsl:value-of select="@TSB1Name4" /></strong>  (<xsl:value-of select="@TSB1N4" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name5 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name5" /></strong>  (<xsl:value-of select="@TSB1N5" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name6 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name6" /></strong>  (<xsl:value-of select="@TSB1N6" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name7 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name7" /></strong>  (<xsl:value-of select="@TSB1N7" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name8 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name8" /></strong>  (<xsl:value-of select="@TSB1N8" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name9 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name9" /></strong>  (<xsl:value-of select="@TSB1N9" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name10 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name10" /></strong>  (<xsl:value-of select="@TSB1N10" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name11 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name11" /></strong>  (<xsl:value-of select="@TSB1N11" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name12 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name12" /></strong>  (<xsl:value-of select="@TSB1N12" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name13 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name13" /></strong>  (<xsl:value-of select="@TSB1N13" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name14 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name14" /></strong>  (<xsl:value-of select="@TSB1N14" />)
			  </td>
			  <td>
    ...
    <xsl:if test="(@TSB1Name15 != '')">
      <tr>
        <td colspan="2">
					  <strong><xsl:value-of select="@TSB1Name15" /></strong> (<xsl:value-of select="@TSB1N15" />)
			  </td>
			  <td>
