...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Resource Stock Outcome Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of resource stock output stock statistics for DevTreks outcomes.
			</p>
			<p>
      ...
      <div id="divsteptwo">
        ...
        <div>
            ...
            <option>
						...
						<option>
							<xsl:attribute name="value">sb102</xsl:attribute>
							<xsl:if test="(@RelatedCalculatorType = 'sb102')">
								<xsl:attribute name="selected" />
							</xsl:if>Output Stocks
						</option>
				  </select>
			  </div>
      ...
      <div id="divsteplast">
        ...
        <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			  ...
			  <ul data-role="listview">
				  <li><strong>Step 1. Base Calculations To Analyze:</strong>  Make sure the data being analyzed corresponds to outcomes.</li>
