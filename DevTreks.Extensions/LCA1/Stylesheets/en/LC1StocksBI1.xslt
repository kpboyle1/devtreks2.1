...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Life Cycle Stock Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic life cycle stock statistics for DevTreks capital budgets
