...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Life Cycle Benefit Calculation View</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic life cycle benefit stock statistics for DevTreks outputs.
			</p>
			<p>
            ...
            <option>
						...
						<option>
							...
							<xsl:if test="(@RelatedCalculatorType = 'buildbenefit1')">
								<xsl:attribute name="selected" />
							</xsl:if>Life Cycle Basic Benefits
						</option>
				  </select>
			  </div>
