...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Life Cycle Outcome Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of life cycle output stock statistics for DevTreks outcomes.
			</p>
			<p>
      ...
      <div id="divsteptwo">
        ...
        <div>
            ...
            <option>
						...
						<option>
							<xsl:attribute name="value">buildbenefit1</xsl:attribute>
							<xsl:if test="(@RelatedCalculatorType = 'buildbenefit1')">
								<xsl:attribute name="selected" />
							</xsl:if>Life Cycle Benefits
						</option>
				  </select>
			  </div>
