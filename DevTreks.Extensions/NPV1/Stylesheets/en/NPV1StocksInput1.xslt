...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Net Present Value Cost Calculation View</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic net present value cost stock statistics for DevTreks inputs.
			</p>
			<p>
