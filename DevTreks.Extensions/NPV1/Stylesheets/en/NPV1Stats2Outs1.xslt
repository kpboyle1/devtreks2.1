    ...
    <xsl:if test="($localName = 'outputgroup')">
      <div data-role="collapsible" data-collapsed="true" data-theme="b" data-content-theme="d" >
        ...
        <div class="ui-grid-a">
          ...
          <div class="ui-block-b">
            Benefit Mean : <xsl:value-of select="@TAMRMean"/>
          </div>
          <div class="ui-block-a">
            Benefit Median : <xsl:value-of select="@TAMRMedian"/>
          </div>
          <div class="ui-block-b">
            Benefit Variance : <xsl:value-of select="@TAMRVariance"/>
          </div>
          <div class="ui-block-a">
            Benefit Std Dev : <xsl:value-of select="@TAMRStandDev"/>
          </div>
          <div class="ui-block-b">    
          </div>
          <div class="ui-block-a">
            Output P Total : <xsl:value-of select="@TRPrice"/>
          </div>
          <div class="ui-block-b">
            Output P Mean : <xsl:value-of select="@TRPriceMean"/>
          </div>
          <div class="ui-block-a">
            Output P Median : <xsl:value-of select="@TRPriceMedian"/>
          </div>
          <div class="ui-block-b">
            Output P Variance : <xsl:value-of select="@TRPriceVariance"/>
          </div>
          <div class="ui-block-a">
            Output P Std Dev : <xsl:value-of select="@TRPriceStandDev"/>
          </div>
          <div class="ui-block-b">    
          </div>
        </div>
