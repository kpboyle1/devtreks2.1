...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:if test="($localName != 'budgetoperation')">
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMRINCENTPPPercent"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMRINCENTPCPercent"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan Period</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan Full</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan Cumul</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Actual Period</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Actual Cumul</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Actual Period Change</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Actual Cumul Change</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan P Percent</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan C Percent</strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Out Q Plan Full Percent</strong></td>
			  <td>
      ...
      <xsl:if test="($localName != 'budgetoperation')">
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan Period </strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan Full</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETPFTotal_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan Cumul</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETPCTotal_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Actual Period</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETAPTotal_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Actual Cumul</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETACTotal_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Actual Period Change</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETAPChange_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Actual Cumul Change</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETACChange_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan P Percent</strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETPPPercent"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETPPPercent_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan C Percent</strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETPCPercent"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETPCPercent_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      <tr>
			  <td scope="row" colspan="1"><strong>Net Plan Full Percent</strong></td>
			  <td>
			  ...
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
				  <xsl:variable name="att_value" select="."/>
					<xsl:value-of select="DisplayComps:printValue('TAMNETPFPercent_', $att_name, $att_value)"/> 
			  </xsl:for-each>
			  <xsl:value-of select="DisplayComps:doPrintValues($fullcolcount)"/>
		  </tr>
      </xsl:if>
