...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:if test="($localName != 'investmentcomponent')">
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>R Incent Total </strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>R Incent Mean</strong></td>
			  <td>
				  <xsl:value-of select="@TAMRINCENTMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>R Incent Median</strong></td>
			  <td>
				  <xsl:value-of select="@TAMRINCENTMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>R Incent Variance</strong></td>
			  <td>
				  <xsl:value-of select="@TAMRINCENTVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>R Incent Std Dev </strong></td>
			  <td>
				  <xsl:value-of select="@TAMRINCENTStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMOCMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMOCVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMOCStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMAOHMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMAOHMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMAOHVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMAOHStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMCAPMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMCAPMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMCAPVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMCAPStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMTOTALMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMTOTALMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  ...
			  <td>
				  <xsl:value-of select="@TAMTOTALVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Total Std Dev </strong></td>
			  <td>
				  <xsl:value-of select="@TAMTOTALStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Incent Total </strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Incent Mean</strong></td>
			  <td>
				  <xsl:value-of select="@TAMINCENTMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Incent Median</strong></td>
			  <td>
				  <xsl:value-of select="@TAMINCENTMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Incent Variance</strong></td>
			  <td>
				  <xsl:value-of select="@TAMINCENTVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Incent Std Dev </strong></td>
			  <td>
				  <xsl:value-of select="@TAMINCENTStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <xsl:if test="($localName != 'investmentcomponent')">
      <tr>
			  <td scope="row" colspan="1"><strong>Net Total </strong></td>
			  <td>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Net Mean</strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETMean"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Net Median</strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETMedian"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Net Variance</strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETVariance"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
      ...
      <tr>
			  <td scope="row" colspan="1"><strong>Net Std Dev </strong></td>
			  <td>
				  <xsl:value-of select="@TAMNETStandDev"/>
			  </td>
			  <xsl:value-of select="DisplayComps:initValues($fullcolcount)"/>
			  <xsl:for-each select="@*">
				  <xsl:variable name="att_name" select="name()"/>
