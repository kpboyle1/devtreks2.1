    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b">
			...
			<p>
              ...
              The 'Penalties' tool displays full machinery costs, including timeliness penalties, for actual machinery combinations. 
			</p>
			<p>
	...
	<xsl:template match="linkedview">
        ...
        <div>
            ...
            <option>
						...
						<option>
							<xsl:attribute name="value">resources02</xsl:attribute>
							<xsl:if test="(@AnalyzerType = 'resources02')">
								<xsl:attribute name="selected" />
							</xsl:if>Resource Actual Machinery Penalties
						</option>
				  </select>
			  </div>
