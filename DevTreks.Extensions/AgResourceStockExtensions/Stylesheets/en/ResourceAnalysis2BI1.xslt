    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This tool generates a variety of basic resource stock selection and scheduling statistics for DevTreks operating budgets and capital budgets. 
              The 'Actual Penalties' tool displays full machinery costs, including timeliness penalties, for the actual machinery combinations chosen. 
			</p>
			<p>
      ...
      <div id="divsteplast">
        ...
        <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			  ...
			  <ul data-role="listview">
				  <li><strong>Step 1. Base Calculations To Analyze:</strong> Make sure the data being analyzed corresponds to either operating budgets or capital budgets. The base calculators must have timeliness penalty calculations.</li>
