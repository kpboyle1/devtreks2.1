...
namespace DevTreks.Extensions
{
    ...
    /// </summary>
    public class BIMN1StockCalculator : BudgetInvestmentCalculatorAsync
    {
        ...
        public bool SetBIGroupMN1Calculations(XElement currentCalculationsElement,
        ...
        public bool SetBIMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
        ...
        public bool SetTimePeriodMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOCGroupMN1Calculations(XElement currentCalculationsElement,
          XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOpOrCompMN1Calculations(XElement currentCalculationsElement,
           XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOutcomeGroupMN1Calculations(XElement currentCalculationsElement,
          XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOutcomeMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetInputGroupMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetInputMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetInputSeriesMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostInputs
        ...
        public bool SetTechInputMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostInputs
        ...
        public bool SetOutputGroupMN1Calculations(XElement currentCalculationsElement,
             XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOutputMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOutputSeriesMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostOutputs
        ...
        public bool SetTechOutputMN1Calculations(XElement currentCalculationsElement,
            XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostOutputs
            ...
            XElement currentElement, XElement currentCalculationsElement)
        {
            ...
            if (!bHasUpdatedCurrentCalcsElement)
            {
                ...
                calc.SetDescendantMN1StockAttributes(attNameExt, lv);
            ...
            XElement currentElement, XElement currentCalculationsElement)
        {
            ...
            if (currentCalculationsElement != null)
            {
                    ...
                    || this.GCCalculatorParams.RelatedCalculatorsType == sRelatedCalculatorsType))
                {
                    ...
                    calc.SetDescendantMN1StockAttributes(attNameExt, currentCalculationsElement);
                }
                else
                {
