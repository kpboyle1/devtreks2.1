...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Food Nutrition Output Analyzer View</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic food nutrition benefit stock statistics for DevTreks outputs.
			</p>
			<p>
	...
	<xsl:template match="linkedview">
      ...
      <div id="divsteptwo">
        ...
        <div>
            ...
            <option>
						...
						<option>
							<xsl:attribute name="value">foodnutSR02</xsl:attribute>
							<xsl:if test="(@RelatedCalculatorType = 'foodnutSR02')">
								<xsl:attribute name="selected" />
      ...
      <div id="divsteplast">
        ...
        <br /><br />
        <h4>Reminder: The 'Resource Stock Totals' analyzer requires running the underlying MN calculator after inserting, deleting, 
								or updating, this linked view (that keeps the MN calculator's linked views synchronized with these linkedviews).
        </h4>
		  </div>
		</xsl:if>
	</xsl:template>
