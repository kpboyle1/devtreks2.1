...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Food Nutrition Operating or Capital Budget Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic food nutrition stock statistics for DevTreks capital budgets
