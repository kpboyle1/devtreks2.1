            ...
            <div class="ui-field-contain">
              <fieldset data-role="controlgroup">
                ...
                <input type="checkbox" id="ContainerPrice" class="custom" >
                  ...
                  <xsl:if test="@ContainerPrice = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="ContainerSizeInSSUnits" class="custom" >
                  ...
                  <xsl:if test="@ContainerSizeInSSUnits = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="ServingCost" class="custom" >
                  ...
                  <xsl:if test="@ServingCost = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="ActualServingSize" class="custom" >
                  ...
                  <xsl:if test="@ActualServingSize = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="TypicalServingSize" class="custom" >
                  ...
                  <xsl:if test="@TypicalServingSize = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="TypicalServingsPerContainer" class="custom" >
                  ...
                  <xsl:if test="@TypicalServingsPerContainer = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="ActualServingsPerContainer" class="custom" >
                  ...
                  <xsl:if test="@ActualServingsPerContainer = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Water_g" class="custom" >
                  ...
                  <xsl:if test="@Water_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Energ_Kcal" class="custom" >
                  ...
                  <xsl:if test="@Energ_Kcal = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Protein_g" class="custom" >
                  ...
                  <xsl:if test="@Protein_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Lipid_Tot_g" class="custom" >
                  ...
                  <xsl:if test="@Lipid_Tot_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Ash_g" class="custom" >
                  ...
                  <xsl:if test="@Ash_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Carbohydrt_g" class="custom" >
                  ...
                  <xsl:if test="@Carbohydrt_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Fiber_TD_g" class="custom" >
                  ...
                  <xsl:if test="@Fiber_TD_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Sugar_Tot_g" class="custom" >
                  ...
                  <xsl:if test="@Sugar_Tot_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Calcium_mg" class="custom" >
                  ...
                  <xsl:if test="@Calcium_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Iron_mg" class="custom" >
                  ...
                  <xsl:if test="@Iron_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Magnesium_mg" class="custom" >
                  ...
                  <xsl:if test="@Magnesium_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Phosphorus_mg" class="custom" >
                  ...
                  <xsl:if test="@Phosphorus_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Potassium_mg" class="custom" >
                  ...
                  <xsl:if test="@Potassium_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Sodium_mg" class="custom" >
                  ...
                  <xsl:if test="@Sodium_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Zinc_mg" class="custom" >
                  ...
                  <xsl:if test="@Zinc_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Copper_mg" class="custom" >
                  ...
                  <xsl:if test="@Copper_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Manganese_mg" class="custom" >
                  ...
                  <xsl:if test="@Manganese_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Selenium_pg" class="custom" >
                  ...
                  <xsl:if test="@Selenium_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_C_mg" class="custom" >
                  ...
                  <xsl:if test="@Vit_C_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Thiamin_mg" class="custom" >
                  ...
                  <xsl:if test="@Thiamin_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Riboflavin_mg" class="custom" >
                  ...
                  <xsl:if test="@Riboflavin_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Niacin_mg" class="custom" >
                  ...
                  <xsl:if test="@Niacin_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Panto_Acid_mg" class="custom" >
                  ...
                  <xsl:if test="@Panto_Acid_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_B6_mg" class="custom" >
                  ...
                  <xsl:if test="@Vit_B6_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Folate_Tot_pg" class="custom" >
                  ...
                  <xsl:if test="@Folate_Tot_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Folic_Acid_pg" class="custom" >
                  ...
                  <xsl:if test="@Folic_Acid_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Food_Folate_pg" class="custom" >
                  ...
                  <xsl:if test="@Food_Folate_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Folate_DFE_pg" class="custom" >
                  ...
                  <xsl:if test="@Folate_DFE_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Choline_Tot_mg" class="custom" >
                  ...
                  <xsl:if test="@Choline_Tot_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_B12_pg" class="custom" >
                  ...
                  <xsl:if test="@Vit_B12_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_A_IU" class="custom" >
                  ...
                  <xsl:if test="@Vit_A_IU = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_A_RAE" class="custom" >
                  ...
                  <xsl:if test="@Vit_A_RAE = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Retinol_pg" class="custom" >
                  ...
                  <xsl:if test="@Retinol_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Alpha_Carot_pg" class="custom" >
                  ...
                  <xsl:if test="@Alpha_Carot_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Beta_Carot_pg" class="custom" >
                  ...
                  <xsl:if test="@Beta_Carot_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Beta_Crypt_pg" class="custom" >
                  ...
                  <xsl:if test="@Beta_Crypt_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Lycopene_pg" class="custom" >
                  ...
                  <xsl:if test="@Lycopene_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Lut_Zea_pg" class="custom" >
                  ...
                  <xsl:if test="@Lut_Zea_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_E_mg" class="custom" >
                  ...
                  <xsl:if test="@Vit_E_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_D_pg" class="custom" >
                  ...
                  <xsl:if test="@Vit_D_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="ViVit_D_IU" class="custom" >
                  ...
                  <xsl:if test="@ViVit_D_IU = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Vit_K_pg" class="custom" >
                  ...
                  <xsl:if test="@Vit_K_pg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="FA_Sat_g" class="custom" >
                  ...
                  <xsl:if test="@FA_Sat_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="FA_Mono_g" class="custom" >
                  ...
                  <xsl:if test="@FA_Mono_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="FA_Poly_g" class="custom" >
                  ...
                  <xsl:if test="@FA_Poly_g = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Cholestrl_mg" class="custom" >
                  ...
                  <xsl:if test="@Cholestrl_mg = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Extra1" class="custom" >
                  ...
                  <xsl:if test="@Extra1 = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
                ...
                <input type="checkbox" id="Extra2" class="custom" >
                  ...
                  <xsl:if test="@Extra2 = true"><xsl:attribute name="checked" /></xsl:if>
                </input>
