...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="outputseries">
    <tr>
      <td scope="row" colspan="10">
        <strong>
          Output Series: <xsl:value-of select="@Name" />
        </strong>
      </td>
    </tr>
    <xsl:variable name="calculatorid">
  ...
  <xsl:template match="root/linkedview">
    ...
    <xsl:if test="(@ContainerSizeInSSUnits > 0)">
      <tr>
        <td>
          <xsl:value-of select="@ContainerSizeInSSUnits" />
        </td>
        <td>
        ...
        <td>
          <xsl:value-of select="@ActualLipid_Tot_g" /> - <xsl:value-of select="@ActualAsh_g" />
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <xsl:value-of select="@ActualVit_D_pg" />-<xsl:value-of select="@ActualViVit_D_IU" />
        </td>
        <td>
        ...
        <td>
          <xsl:value-of select="@ActualFA_Mono_g" />-<xsl:value-of select="@ActualFA_Poly_g" />
        </td>
        <td>
          <xsl:value-of select="@ActualCholestrl_mg" />
        </td>
        <td>
          <xsl:value-of select="@ActualExtra1" />-<xsl:value-of select="@ActualExtra2" />
        </td>
      </tr>
      <tr>
        <td colspan="10">
