...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="root">
		...
		<div id="divstepzero">
      <h4 class="ui-bar-b"><strong>Food Nutrition USDA Standard Reference Output Calculation View</strong></h4>
      <xsl:choose>
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This calculator calculates the nutritional value of outputs per actual serving size 
      ...
      <xsl:value-of select="DisplayDevPacks:WriteAlternatives($searchurl, $viewEditType,
          ...
          <div >
              ...
              <xsl:if test="($viewEditType = 'full')">
					...
					<xsl:when test="($docToCalcNodeName = 'output' 
							  or $docToCalcNodeName = 'outputseries'
							  or contains($docToCalcNodeName, 'devpack') 
							  or contains($docToCalcNodeName, 'linkedview'))">
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			...
			<ul data-role="listview">
				<li><strong>Step 1. Real and Nominal Rates:</strong> The nominal rate includes inflation while the real rate does not. In the USA, DevTreks recommends 
					using Office of Management and Budget rates for the same year as the date of the output.</li>
			</ul>
      </div>
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			<h4>Step 2</h4>
        ...
        <li>
          <strong>Step 3. Container Size and Unit:</strong> Enter the size and unit of measurement of the output container holding this food item. Convert the containter units of measurement to the same units found in the typical serving size units.
        </li>
        <li>
          <strong>Step 3. Container Price and CAP Price:</strong>  The container price is the output price of the container holding this food item. Unlike inputs, outputs don't have a CAP price property.
        </li>
        <li>
        ...
        <li>
          <strong>Step 3. R Amount:</strong> The per unit amount of the food item will be 1 (unit serving size portion).This quantity can be adjusted when the output is added to budgets.
        </li>
        <li><strong>Step 3. R Price:</strong> The per unit revenue of the food item is calculated automatically.</li>
        <li><strong>Step 3. R Unit:</strong> This unit is entered automatically from the ActualServingSize and the Typical USDA Serving Size selection..</li>
        <li><strong>Step 3. Serving Revenue:</strong> The revenue of the food item uses the actual serving size in the calculation: ActualServingSize * RPrice.</li>
        <li><strong>Step 3. Food Nutrition Composition:</strong> The starting food nutrients come directly from the USDA National Nutrient Database for Standard
          Reference, Release 24. The food nutrient composition of the 'Actual Serving Size' is computed by the calculator. The calculations use formulas found in the reference document for this tutorial.</li>
			</ul>
      </div>
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
