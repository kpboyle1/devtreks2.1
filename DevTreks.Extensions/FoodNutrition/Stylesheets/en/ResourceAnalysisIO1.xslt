    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This tool generates a variety of basic food nutrition stock statistics for DevTreks inputs.
			</p>
			<p>
	...
	<xsl:template match="linkedview">
        ...
        <div>
            ...
            <option>
						...
						<option>
							...
							<xsl:if test="(@FilesToAnalyzeExtensionType = 'foodfactUSA1')">
								<xsl:attribute name="selected" />
							</xsl:if>Food Facts USA
						</option>
            <option>
							<xsl:attribute name="value">foodnutSR01</xsl:attribute>
							<xsl:if test="(@FilesToAnalyzeExtensionType = 'foodnutSR01')">
								<xsl:attribute name="selected" />
      ...
      <div id="divsteptwo">
        ...
        <xsl:if test="($viewEditType = 'full')">
         ...
         <xsl:if test="($docToCalcNodeName = 'inputgroup' or $docToCalcNodeName = 'outputgroup'
							or $docToCalcNodeName = 'input' or $docToCalcNodeName = 'output'
							or contains($docToCalcNodeName, 'devpack'))">
      ...
      <div id="divsteplast">
        ...
        <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			  ...
			  <ul data-role="listview">
				  <li><strong>Step 1. Base Calculations To Analyze:</strong> Make sure the data being analyzed corresponds to either inputs or outputs.</li>
