...
<!-- Author: www.devtreks.org, 2013, March -->
	...
	<xsl:if test="(@Id = $linkedviewid) or (@Id = 1)">
            ...
            <xsl:if test="($viewEditType = 'full')">
              ...
              <div data-role="collapsible" data-collapsed="false" data-theme="b" data-content-theme="d">
                ...
                <div class="ui-grid-a">
                  ...
                  <div class="ui-block-b">
                    <strong>Actual Retinol</strong>:
                    <xsl:value-of select="@ActualRetinol_pg"/>
                  </div>
                </div>
                <div class="ui-grid-a">
                  <div class="ui-block-a">
                    <strong>Actual Alpha Carotene</strong>:
                ...
                <div class="ui-grid-a">
                  ...
                  <div class="ui-block-b">
                    <strong>Actual Vitamin K</strong>:
                    <xsl:value-of select="@ActualVit_K_pg"/>
                  </div>
                </div>
                <div class="ui-grid-a">
                  <div class="ui-block-a">
                    <strong>Actual Fatty Acid Sat</strong>:
                    <xsl:value-of select="@ActualFA_Sat_g"/>
                  </div>
                  <div class="ui-block-b">
                    <strong>Actual Fatty Acid Mono</strong>:
                    <xsl:value-of select="@ActualFA_Mono_g"/>
                  </div>
                </div>
                <div class="ui-grid-a">
                  <div class="ui-block-a">
                    <strong>Actual Fatty Acid Poly</strong>:
                    <xsl:value-of select="@ActualFA_Poly_g"/>
                  </div>
                  <div class="ui-block-b">
                    <strong>Actual Cholesterol</strong>:
            ...
            <xsl:if test="($viewEditType = 'full')">
              ...
              <div>
                <label for="lblWeightToUseType" >
                  <strong>Typical USDA Serving Size</strong>
                </label>
              ...
              <div>
                <label for="ContainerSizeUsingServingSizeUnit">
                  <strong>
                    Container Size (Typical USDA Serving Size Unit: <xsl:value-of select="@ServingSizeUnit"/>)
                  </strong>
                </label>
                <xsl:if test="($viewEditType = 'print') or ($viewEditType = 'part')">
                  <input type="text" id="ContainerSizeUsingServingSizeUnit">
                    <xsl:attribute name="value"><xsl:value-of select="@ContainerSizeUsingServingSizeUnit"/></xsl:attribute>
                  </input>
                </xsl:if>
                <xsl:if test="($viewEditType = 'full')">
                  <input type="text" id="ContainerSizeUsingServingSizeUnit">
                    <xsl:attribute name="name">
                      <xsl:value-of select="$searchurl"/>;ContainerSizeUsingServingSizeUnit;decimal;8</xsl:attribute>
                    <xsl:attribute name="value"> <xsl:value-of select="@ContainerSizeUsingServingSizeUnit"/></xsl:attribute>
                  </input>
                </xsl:if>
              </div>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
        ...
        <li><strong>Step 2. What If Tag Name:</strong> Instructional videos explaining the use of what-if scenario calculations should be viewed before changing or using this parameter.</li>
				...
				<li><strong>Step 3. Typical USDA Serving Size:</strong> The USDA food nutrient database contains two typical household portion, or serving, sizes. Either size can be chosen using metric or standard USA imperial units of measurement. Weight 1 is larger, and contains more measurements, than weight 2. Use weight 1 as the default. </li>
        <li><strong>Step 3. Actual Serving Size:</strong> Adjust the Typical USDA Serving Size to the actual serving size consumed in a typical meal. For example, if the typical serving size is 3 oz, but 4 oz are actually consumed in a typical meal, enter 4.</li>
				<li><strong>Step 3. Container Size:</strong> Enter the size of food container holding this food item. Convert the units of measurement to the same units found in the typical serving size units.</li>
        <li><strong>Step 3. CAP Price (Container Cost):</strong>  Prior to running the calculation make sure that the container cost, which is found on grocery bills, is first entered as the CAP Price for the associated input.</li>
        <li><strong>Step 3. OC Price:</strong> The per unit cost of the food item is calculated automatically (container cost / container size).</li>
        <li><strong>Step 3. OC Unit:</strong> This unit is entered automatically from the Typical USDA Serving Size selection.</li>
        <li><strong>Step 3. Serving Cost:</strong> The cost of the food item uses the actual serving size in the calculation: ActualServingSize * OCPrice.</li>
        <li><strong>Step 3. Food Nutrition Composition:</strong> The starting food nutrients come directly from the USDA National Nutrient Database for Standard
          Reference, Release 24. The food nutrient composition of the 'Actual Serving Size' is computed by the calculator. The calculations use formulas found in the reference document for that database.</li>
			</ul>
      </div>
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
      <h4 class="ui-bar-b"><strong>References</strong></h4>
      <ul data-role="listview">
        <li><strong>USDA, ARS</strong> Composition of Foods Raw, Processed, Prepared USDA National Nutrient Database for Standard
          Reference, Release 24. September, 2011. (http://www.ars.usda.gov/nutrientdata)</li>
			</ul>
      </div>
		</div>
	</xsl:if>
