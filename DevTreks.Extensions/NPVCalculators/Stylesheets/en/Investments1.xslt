...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="investmentgroup">
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b">
          <strong>Investment Group Details</strong>
        </h4>
			  <div>
      ...
      <xsl:if test="(@TAMNET != 'NaN')">
        <div class="ui-grid-a">
          ...
          <div class="ui-block-a">
            Net OC Returns : <xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, 0, 0)"/>
          </div>
          <div class="ui-block-b">
            Ann Net OC Returns : <xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TAMR, @TAMOC, 0, 0)"/>
          </div>
          <div class="ui-block-a">
          ...
          <div class="ui-block-a">
            Net AOH Returns : <xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, @TAOH, 0)"/>
          </div>
          <div class="ui-block-b">
            Ann Net AOH Returns : <xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TAMR, @TAMOC, @TAMAOH, 0)"/>
          </div>
          <div class="ui-block-a">
          ...
          <div class="ui-block-a">
            Net Returns : <xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, @TAOH, @TCAP)"/>
          </div>
          <div class="ui-block-b">
            Ann Net Returns : <xsl:value-of select="@TAMNET"/>
          </div>
          <div class="ui-block-a">
          ...
          <div class="ui-block-b">
            Net Ann Incent Return : <xsl:value-of select="@TAMINCENT_NET"/>
          </div>
      </div>
      </xsl:if>
    </div>
    ...
    <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
		  <h4 class="ui-bar-b">
        <strong>Time Period : <xsl:value-of select="@PracticeName" /></strong>
      </h4>
      <div>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        ...
        <div class="ui-grid-a">
          ...
          <div class="ui-block-a">
            Amount : <xsl:value-of select="@PracticeAmount" />
          </div>
          <div class="ui-block-b">
          ...
          <div class="ui-block-b">
            Unit : <xsl:value-of select="@PracticeUnit" />
          </div>
          <div class="ui-block-a">
    ...
    <xsl:if test="($docToCalcNodeName != 'investmentgroup')">
		  <h4 class="ui-bar-b">
        Benefits
		  </h4>
