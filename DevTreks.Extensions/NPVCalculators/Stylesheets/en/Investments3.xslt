...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="investmentgroup">
        ...
        <td scope="row" colspan="4">
          Label : <xsl:value-of select="@Num" />
				...
				<td scope="row" colspan="4">
					Investment Type : <xsl:value-of select="DisplayDevPacks:WriteSelectListForTypes($searchurl, @ServiceId, @TypeId, 'TypeId', $viewEditType)"/>
				</td>
			</tr>
      <tr>
        <td scope="row" colspan="4">
      ...
      <xsl:if test="(@TAMNET != 'NaN')">
        ...
        <tr>
				  <td scope="row" colspan="4">Total Incentives Ben -Investment Group</td>
			  ...
			  <tr>
				  <td scope="row" colspan="4">Total Incentive Costs - Investment Group</td>
			  ...
			  <tr>
				  <td scope="row" colspan="4">Net Incentive Returns - Investment Group</td>
	...
	<xsl:template match="investment">
      ...
      <xsl:if test="(@TAMNET != 'NaN')">
			  ...
			  <tr>
				  <td colspan="4">Total Benefit -Investment</td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TR"/></td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TAMR"/></td>
			  </tr>
				  <tr>
					  <td colspan="4">Total Operating Costs -Investment</td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TOC"/></td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TAMOC"/></td>
				  </tr>
				  <tr>
					  <td scope="row" colspan="4">Net Operating Returns -Investment</td>
				  ...
				  <tr>
					  <td colspan="4">Total Allocated Overhead Costs -Investment</td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TAOH"/></td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TAMAOH"/></td>
				  </tr>
				  <tr >
					  <td colspan="4">Net Operating and Overhead Returns -Investment</td>
				  ...
				  <tr>
					  <td colspan="4">Total Capital Expenditure Costs -Investment</td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TCAP"/></td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TAMCAP"/></td>
				  </tr>
				  <tr >
					  <td colspan="4">Net Returns -Investment</td>
					  <td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, @TAOH, @TCAP)"/></td>
					  <td class="Content150" colspan="2"><xsl:value-of select="@TAMNET"/></td>
				  </tr>
			  <tr >
				  <td colspan="6">Equivalent Annual Annuity -Investment</td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@InvestmentEAA"/></td>
			  </tr>
        <tr>
				  <td scope="row" colspan="4">Total Incentive Ben -Investment</td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TRINCENT"/></td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TAMRINCENT"/></td>
			  </tr>
			  <tr>
				  <td colspan="4">Total Incentive Costs -Investment</td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TINCENT"/></td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TAMINCENT"/></td>
			  </tr>
			  <tr>
				  <td colspan="4">Net Incentive Returns -Investment</td>
				  <td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TINCENT, 0, 0)"/></td>
				  <td class="Content150" colspan="2"><xsl:value-of select="@TAMINCENT_NET"/></td>
			  </tr>
      </xsl:if>
	...
	<tr>
		<th scope="col" colspan="8">
			Time Period : <strong><xsl:value-of select="@PracticeName" /></strong>
		</th>
	</tr>
	<tr>
		<th>
	...
	<tr>
      ...
      <xsl:value-of select="@DiscountYorN" />
		...
		<td>
      <xsl:value-of select="@PracticeAmount" />
		</td>
		<td colspan="2">
			<xsl:value-of select="@PracticeUnit"/>
		</td>
		<td>
	...
	<tr>
		...
		<tr>
			<th scope="col" colspan="8">Benefits</th>
		</tr>
		<xsl:apply-templates select="investmentoutcomes" />
			...
			<tr>
				<td scope="row" colspan="4">Total Benefit -Time Period</td>
				<td class="Content150" colspan="2"><xsl:value-of select="@TR"/></td>
				<td class="Content150" colspan="2"><xsl:value-of select="@TAMR"/></td>
			</tr>
      <tr>
    ...
    <tr>
		...
		<tr>
			<td scope="row" colspan="4">Net Operating Returns -Time Period</td>
			<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, 0, 0)"/></td>
			<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TAMR, @TAMOC, 0, 0)"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td scope="row" colspan="4">Net Operating and Overhead Returns -Time Period</td>
			<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, @TAOH, 0)"/></td>
			<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TAMR, @TAMOC, @TAMAOH, 0)"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td scope="row" colspan="4">Net Returns -Time Period</td>
			<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TOC, @TAOH, @TCAP)"/></td>
			<td class="Content150" colspan="2"><xsl:value-of select="@TAMNET"/></td>
		</tr>
		<tr>
			...
			<tr>
				<td scope="row" colspan="4">Net Incentive Returns -Time Period</td>
				<td class="Content150" colspan="2"><xsl:value-of select="DisplayDevPacks:GetSubtractNumberN2(@TR, @TINCENT, 0, 0)"/></td>
				<td class="Content150" colspan="2"><xsl:value-of select="@TAMINCENT_NET"/></td>
			</tr>
	</xsl:template>
  ...
  <tr>
    ...
    <xsl:apply-templates select="investmentoutput">
      ...
      <tr>
        <td scope="row" colspan="6">Benefit Interest - Outcome</td>
        <td>
    ...
    <tr>
      <td scope="row" colspan="6">Total Benefit - Outcome</td>
      <td>
    ...
    <tr>
		  <td colspan="6">Total Incentive-Adjusted Benefits - Outcome</td>
	...
	<xsl:template match="investmentoutput">
      ...
      <td scope="row">
		...
		<tr>
			<td scope="row" colspan="6">Total Output Benefit</td>
			<td>
  ...
  <tr>
    ...
    <tr>
      <td scope="row" colspan="6">Total Operating Costs - Component</td>
      <td>
    ...
    <tr>
			<td colspan="6">Total Allocated Overhead Costs - Component</td>
    ...
    <tr>
			<td colspan="6">Total Capital Costs - Component</td>
			<td><xsl:value-of select="@TCAP"/></td>
			<td><xsl:value-of select="@TAMCAP"/></td>
		</tr>
    <tr>
			<td colspan="6">Total Incentive-Adjusted Costs - Component</td>
