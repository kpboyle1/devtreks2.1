...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<!-- is this a cost list or an actual component? 
	<xsl:variable name="isPriceList" select="//componentgroup/@PriceListYorN"/>-->
	<!-- init html -->
	...
	<xsl:template match="componentgroup">
		  <xsl:variable name="searchurl"><xsl:value-of select="DisplayDevPacks:GetURIPattern(@Name,@Id,$networkId,local-name(),'')" /></xsl:variable>
			<tr>
				<th scope="col" colspan="8">
					Component Group : <xsl:value-of select="@Name" />
				</th>
			</tr>
			<tr>
				<td scope="row" colspan="8">
        ...
        <td scope="row" colspan="4">
          Label : <xsl:value-of select="@Num" />
				...
				<td scope="row" colspan="4">
					Component Type : <xsl:value-of select="DisplayDevPacks:WriteSelectListForTypes($searchurl, @ServiceId, @TypeId, 'TypeId', $viewEditType)"/>
				</td>
			</tr>
			<tr>
				<td scope="row" colspan="8">
	...
	<xsl:template match="component">
			<tr>
				<th scope="col" colspan="8">Component</th>
			</tr>
			<tr>
				<th scope="col">
					Date&#xA0;Applied
          ...
          <xsl:value-of select="@IncentiveRate" />
				...
				<tr>
					<td scope="row" colspan="3">
						Component Unit:<xsl:value-of select="@Unit"/>
					</td>
					<td colspan="1">
						ResourceWeight
					</td>
				...
				<tr>
					<th scope="col" colspan="2"><strong>Total Costs - Component </strong></th>
				...
				<tr>
					<td scope="row" colspan="2"><strong>Total Costs - Component </strong></td>
				...
				<tr>
					<td scope="row" colspan="2"><strong>Total Costs - Component w. Incentives </strong> </td>
