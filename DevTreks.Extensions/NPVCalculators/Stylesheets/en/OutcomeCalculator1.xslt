...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="root">
		...
		<div id="divstepzero">
      <h4 class="ui-bar-b"><strong>Outcome Calculation View</strong></h4>
      <xsl:choose>
        <xsl:when test="($docToCalcNodeName = 'outcomegroup' 
				...
				<xsl:otherwise>
					<h3>This outcome calculator does not appear appropriate for the document being analyzed. Are you 
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This tool calculates net present value totals for outcome uris. The discounted totals include benefit and incentive-adjusted totals. Outcomes that have an effective life different than 1 period 
    ...
    <div id="divsteptwo">
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			<h4>References</h4>
        <ul data-role="listview">
				  <li>This version of the outcome calculator uses the same patterns and calculations as the related npv operation and component calculator. 
          Future versions are expected to include additional types of outcome calculations (i.e. such as those used to monitor and evaluate 
          projects or programs).</li>
			  </ul>
      </div>
		</div>
		</xsl:if>
