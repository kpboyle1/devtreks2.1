...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Health Care Outcome Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic health care stock statistics for DevTreks outcomes.
			</p>
			<p>
            ...
            <option>
						...
						<option>
							...
							<xsl:if test="(@RelatedCalculatorType = 'hcbenefit1')">
								<xsl:attribute name="selected" />
							</xsl:if>Health Care Basic Benefits
						</option>
				  </select>
			  </div>
      </div>
