...
<xsl:stylesheet version="1.0"
    ...
    <div id="divstepzero">
      ...
      <h4 class="ui-bar-b"><strong>Health Care Stock Analyzer Views</strong></h4>
      <h4 class="ui-bar-b">
					<strong>
			...
			<p>
					...
					<br />
					This tool generates a variety of basic health care stock statistics for DevTreks operating budgets and capital budgets.
			</p>
			<p>
      ...
      <div id="divsteptwo">
        ...
        <div>
            ...
            <option>
						...
						<option>
							<xsl:attribute name="value">healthcost1</xsl:attribute>
							<xsl:if test="(@RelatedCalculatorType = 'healthcost1')">
								<xsl:attribute name="selected" />
							</xsl:if>Health Care Costs
						</option>
            <option>
							<xsl:attribute name="value">hcbenefit1</xsl:attribute>
							<xsl:if test="(@RelatedCalculatorType = 'hcbenefit1')">
								<xsl:attribute name="selected" />
							</xsl:if>Health Care Benefits
						</option>
				  </select>
			  </div>
        <xsl:if test="(@AnalyzerType != 'resources01')">
